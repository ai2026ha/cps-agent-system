...
const playerBaseCols=[['玩家ID','player_id'],['账号','username'],['角色','characters',playerCharactersCell],['所属代理','agent_public_id'],['平台币余额','platform_coin_balance'],['今日充值','today_recharge'],['总充值','total_recharge'],['状态','status',playerStatusBadge],['注册时间','created_at'],['最后登录','last_login_at'],['登录IP','last_login_ip']];
